...
from graphics.scene_graphics import QDMGraphicsScene
from classes.vertex import Node
from classes.edge import Edge
from scene.history import SceneHistory
from scene.clipboard import SceneClipboard
...
class Scene(Serializable):
    ...
    def __init__(self):
        ...
        :Instance Attributes:
            ...
            - **vertices** - list of `Nodes` in this `Scene`
    ...
    def removeNode(self, node:Node):
        ...
        if node in self.nodes: self.nodes.remove(node)
            ...
            if DEBUG_REMOVE_WARNINGS: print("!W:", "Scene::removeNode", "wanna remove nodeeditor", node,
                                            "from self.vertices but it's not in the list!")
