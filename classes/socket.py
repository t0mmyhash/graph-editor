...
from graphics.socket_graphics import QDMGraphicsSocket
...
class Socket(Serializable):
    ...
    def __init__(self, node:'Node', index:int=0, position:int=LEFT_CENTER, socket_type:int=1, multi_edges:bool=True, count_on_this_node_side:int=1, is_input:bool=False):
        """
