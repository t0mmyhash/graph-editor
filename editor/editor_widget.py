...
from scene.scene import Scene, InvalidFile
from classes.vertex import Node
from classes.edge import Edge, EDGE_TYPE_BEZIER
from graphics.view_actions import QDMGraphicsView
...
class NodeEditorWidget(QWidget):
    ...
    def getUserFriendlyFilename(self) -> str:
        ...
        :rtype: ``str``
        """
        name = os.path.basename(self.filename) if self.isFilenameSet() else "Граф"
