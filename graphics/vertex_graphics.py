...
class QDMGraphicsNode(QGraphicsItem):
    ...
    def initAssets(self):
        ...
        self._title_color = Qt.transparent
        self._title_font = QFont("Ubuntu", 80)
        ...
        self._brush_background = QBrush(QColor("#f5f5f5"))
    ...
    def mouseMoveEvent(self, event):
        ...
        # optimize me! just update the selected vertices
    ...
    def mouseReleaseEvent(self, event):
        ...
        if self._was_moved:
            ...
            # we need to store the last selected state, because moving does also select the vertices
    ...
    def initContent(self):
        ...
        if self.content is not None:
            self.content.setGeometry(self.edge_padding, self.edge_padding,
    ...
    def paint(self, painter, QStyleOptionGraphicsItem, widget=None):
        ...
        path_title.addEllipse(0, 0, self.width, self.width)
        ...
        path_outline.addEllipse(-1, -1, self.width+2, self.width+2)
        painter.setBrush(Qt.NoBrush)
        if self.hovered:
